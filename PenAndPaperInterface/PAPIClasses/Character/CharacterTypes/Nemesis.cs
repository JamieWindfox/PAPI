...
namespace PAPI.Character.CharacterTypes
{
    public class Nemesis : UniqueRival
    {
        ...
        public Nemesis(string _archetype, Species _species, Value _soak, ThresholdValue _health, Defense _defense, CharacteristicSet _characteristics,
            ...
            int _relationshipToParty, List<CriticalInjury> _criticalInjuries, string _name, MotivationSet _motivationSet, ThresholdValue _strain) :
            base(_archetype, _species, _soak, _health, _defense, _characteristics, _equipment, _inventory, _skillSet, _abilities, _career, _appearance,
                _relationshipToParty, _criticalInjuries, _name, _motivationSet)
        {
